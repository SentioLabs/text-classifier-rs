...
ROUTING_TABLE: dict[str, tuple[str, str]] = {
    ...
    "javascript": ("google/gemini-3-flash-preview", "openrouter"),
    "key_value": ("google/gemini-3-flash-preview", "openrouter"),
    "pipe_table": ("google/gemini-3-flash-preview", "openrouter"),
    "rst": ("google/gemini-3-flash-preview", "openrouter"),
    "sgml": ("google/gemini-3-flash-preview", "openrouter"),
    "toml": ("google/gemini-3-flash-preview", "openrouter"),
