...
def _flush_checkpoint(
    ...
    Writes all completed results from flushed_up_to onwards, skipping
    None entries (still in progress). This ensures concurrent workers
    don't lose progress when indices complete out of order.
    """
