...
class TestSplitDataset:
    def test_split_small_dataset(self, tmp_path):
        ...
        # Verify CSV columns
        assert set(train_rows[0].keys()) == {"text", "category", "sub_type", "source"}
        # All sources should be "golden_synthetic"
        assert all(r["source"] == "golden_synthetic" for r in train_rows)
